...
ggsave("genomic_vs_telomeric.pdf", plot=plt, width=12, height=10, units="cm")
...
ggsave("genomic_vs_telomeric_segregated_by_type.pdf", plot=plt, width=12, height=10, units="cm")
...
if (!flag){
  ...
  ggsave("genomic_vs_telomeric_segregated_by_type_and_strand.pdf", plot=plt, width=12, height=10, units="cm")
}
